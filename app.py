...
predictor = st.selectbox('what would you like to predict:', ('Flowability','Roll Pressure'), help='**Flowability** assumes you have a target roll pressure and solid fraction, \n while **Roll Pressure** assumes you have a target flowability and solid fraction')
